...
public class FileGeneratorV1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; i <= perFormat; i++) {
            createTextFile(folderPath + File.separator + "file_" + i + ".txt", randomSize());
            createCsvFile(folderPath + File.separator + "file_" + i + ".csv", randomSize());
            createXlsFile(folderPath + File.separator + "file_" + i + ".xls", randomSize());
            createDocxFile(folderPath + File.separator + "file_" + i + ".docx", randomSize());
            createPdfFile(folderPath + File.separator + "file_" + i + ".pdf", randomSize());

            System.out.println("Generated " + i*5 + " files (" + i + " per format) in " + folderPath);
        }
